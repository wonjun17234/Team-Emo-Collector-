...
import { drawHome, pressedHome } from './states/home.js';
import { drawScanFace, pressedScanFace } from './states/scanFace.js';
import { drawSituation, pressedSituation } from './states/situation.js';
import { drawCollectEmotion, pressedCollectEmotion } from './states/collectEmotion.js';
import { drawReport, pressedReport } from './states/report.js';
...
function draw() {
  ...
  switch (currentState.value) {
    ...
    case State.ScanFace: drawScanFace(); break;
    case State.Situation: drawSituation(); break;
    case State.CollectEmotion: drawCollectEmotion(); break;
    case State.Report: drawReport(); break;
  }
